...
<head>
  ...
  <meta http-equiv="content-type" content="text/html; charset=<tag:main_charset />" />
    <!-- Bootstrap Core CSS -->
    <link href="style/Xbtit_3.0/css/bootstrap.css" rel="stylesheet">
    <!-- Theme CSS -->
    <link href="style/Xbtit_3.0/main.css" rel="stylesheet">
    <!-- Custom Fonts -->
...
<div id="main">
    ...
    <script src="style/Xbtit_3.0/js/bootstrap.min.js"></script>
...
<br /><br /><br /><br /> 
  <div id="logo">
    ...
    <TABLE align="center" width="100%" height="75" cellpadding="0" cellspacing="0" border="0">
      <TR>
        <TD valign="top" background="style/Xbtit_3.0/images/spacer.gif"></TD>
       </TR>
    </TABLE>
